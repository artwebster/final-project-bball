...
const { getGames, getGames2, getNews, getOdds, getOddsNew, getStandings, getLiveScores } = require("./handlers");
...
express()
  ...
  .get("/api/get-games2/:date", getGames2)
  .get("/api/get-live-scores", getLiveScores)
